...
class BottomBarPageView(
    private val bottomBarPageViewModel: BottomBarPageViewModel,
    private val userDataModel: UserDataModel,
    private val bottomNavBarViewModel: BottomNavBarViewModel
) : BasePage<BottomBarPageViewModel>(viewModel = bottomBarPageViewModel) {
    ...
    override fun BottomNavBar() {
        ...
        val tab = rememberSaveable { mutableStateOf(0) }

...
import com.get.set.designsystem.components.AppSnackBar
import com.get.set.designsystem.components.AppSnackBarType
import com.get.set.designsystem.components.AppSnackBarVisuals
    ...
    override fun Content(paddingValues: PaddingValues, viewModel: TaskViewModel) {
        ...
        Box {
            Column(
                ...
                AppTextField(
                    showLabelOnTop = true,
                    value = viewModel.taskScreenState.value.description ?: "",
                    onValueChange = {
